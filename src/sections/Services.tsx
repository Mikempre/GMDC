...
export const Services: React.FC = () => {
  const services = [
    ...
    {
      title: "Fabric Protect & Restoration Service",
    ...
    {
      title: "Fumigation & Pest Control Service",
  ...
  return (
    <section id="services" className="py-32 bg-white dark:bg-[#081630] relative transition-colors duration-300">
