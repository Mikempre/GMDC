      ...
      <section className="py-24 bg-white dark:bg-[#061c47] transition-colors duration-300 border-t border-gray-100 dark:border-brandBlue-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p>
              With our three strategically located outlets, you also have the option of getting a more personalised service by walking into our laundry outlets nearest to you. Gran Maestro is your neighbourhood one-stop-shop for all things clothes & related items. We make it a point to understand clothes and fabrics better. So be it laundry, drycleaning those special clothes, steam pressing those washed clothes or cleaning your shoes and bags, entrust your garment to us. We will launder your clothes exactly as we will treat ours. With care.
            </p>
