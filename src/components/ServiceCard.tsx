  ...
  return (
    ...
    >
      <motion.div
        ...
        ${dark 
          ? 'border-brandBlue-700/50 hover:border-brandBlue-500/50 text-white' 
          : 'border-white/50 hover:border-brandBlue-300/80 text-brandBlue-900'}
        `}
      >
        ...
        <h3 className="text-2xl font-serif font-bold mb-4 relative z-10 transition-colors group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-brandBlue-500 group-hover:to-brandBlue-500 dark:group-hover:from-brandBlue-400 dark:group-hover:to-white">
          {title}
        </h3>
