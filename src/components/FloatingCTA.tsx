...
export const FloatingCTA: React.FC = () => {
  return (
    <motion.a
      href="https://wa.me/2348000000000" // Replace with actual WhatsApp link
      target="_blank"
      rel="noopener noreferrer"
      initial={{ scale: 0, opacity: 0 }}
      animate={{ scale: 1, opacity: 1 }}
      transition={{ delay: 1, type: "spring", stiffness: 200, damping: 20 }}
      className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[100] flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gradient-to-r from-brandRed-500 to-brandRed-600 text-white shadow-[0_10px_30px_rgba(211,26,33,0.4)] hover:shadow-[0_10px_40px_rgba(211,26,33,0.6)] transform hover:-translate-y-1 hover:scale-105 transition-all duration-300 group"
    ...
    >
      ...
      {/* Ripple effect */}
      <div className="absolute inset-0 rounded-full animate-ping opacity-20 bg-brandRed-500"></div>
    </motion.a>
  );
};
